Attribute VB_Name = "modToolsFileProperty"
Option Explicit
...
Public Function GetOneCustomProp(ByRef wb As Workbook, ByVal NameProp As String) As String
    On Error Resume Next
    GetOneCustomProp = wb.CustomDocumentProperties(NameProp).Value
    On Error GoTo 0
End Function
