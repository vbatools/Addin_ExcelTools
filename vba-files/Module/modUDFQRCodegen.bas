Attribute VB_Name = "modUDFQRCodegen"
Option Explicit
...
'=========================================================================
Public Const VERSION_MIN As Long = 1
Public Const VERSION_MAX As Long = 40
...
Private Function QRCodegenEncode(TextOrByteArray As Variant, baQrCode() As Byte, _
    ...
    Dim sText       As String
    Dim lBufLen     As Long
    Dim uSegments() As QRCodegenSegment   'public
...
Private Function QRCodegenEncodeSegments(uSegments() As QRCodegenSegment, baQrCode() As Byte, _
        ...
        Optional ByVal MaxVersion As Long = VERSION_MAX, _
        Optional ByVal Mask As QRCodegenMask = QRCodegenMask_AUTO, _
        Optional ByVal BoostEcl As Boolean = True) As Boolean                'public
...
Private Function QRCodegenConvertToPicture(baQrCode() As Byte, _
        Optional ByVal ForeColor As OLE_COLOR = vbBlack, _
        Optional ByVal ModuleSize As Long = 120, _
        Optional ByVal SquareModules As Boolean) As StdPicture                'public
...
Private Function QRCodegenConvertToData(ByVal pPicture As IPicture, Optional ByVal NewWidth As Long, Optional ByVal NewHeight As Long) As Byte()           'public
...
Public Function QRCodegenResizePicture(pPicture As IPicture, ByVal NewWidth As Long, ByVal NewHeight As Long) As StdPicture
    ...
    Else
        pPicture.Render CLng(hDC), 0, 0, NewWidth, NewHeight, 0, pPicture.Height, pPicture.Width, -pPicture.Height, 0
    End If
